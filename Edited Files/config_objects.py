...
from tmrl.custom.custom_models import SquashedGaussianMLPActor, MLPActorCritic, REDQMLPActorCritic, RNNActorCritic, SquashedGaussianRNNActor, SquashedGaussianVanillaCNNActor, VanillaCNNActorCritic, SquashedGaussianVanillaColorCNNActor, VanillaColorCNNActorCritic, DQN, DQNActor
...
from tmrl.custom.custom_algorithms import RAINBOWAgent as RAIN_Agent
...
assert ALG_NAME in ["SAC", "REDQSAC", "RAIN"], f"If you wish to implement {ALG_NAME}, do not use 'ALG' in config.json for that."
...
UPDATER_FN = update_run_instance if ALG_NAME in ["SAC", "REDQSAC", "RAIN"] else None
